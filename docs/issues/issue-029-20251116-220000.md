...
- **Graph: Slope-Intercept** → Should show interactive canvas with slope-intercept graphing questions
- **Graph: Point-Slope** → Should show interactive canvas with point-slope graphing questions
- **Graph: Parallel Lines** → Should show 2-step parallel line graphing questions
- **Graph: Perpendicular Lines** → Should show 2-step perpendicular line graphing questions
- **Graph: Absolute Value** → Should show 3-point absolute value graphing questions
...
function mapTabToProblemType(tabName) {
    ...
    return mapping[tabName] || 'slope';  // ← Defaults to 'slope'!
}
```
...
3. Extracts tab name: `const tabName = activeTab.dataset.tab;` → `"graph-slopeintercept"`
...
7. Challenge shows "Slope & Description" questions ❌
...
function mapTabToProblemType(tabName) {
    const mapping = {
        ...
        'graph-slopeintercept': 'graphSlopeIntercept',    // ✅ NEW
        'graph-pointslope': 'graphPointSlope',            // ✅ NEW
        'graph-parallel': 'graphParallel',                // ✅ NEW
        'graph-perpendicular': 'graphPerpendicular',      // ✅ NEW
        'graph-absolutevalue': 'graphAbsoluteValue'       // ✅ NEW
    };
...
- ✅ Navigate to Graph: Slope-Intercept tab
- ✅ Start Challenge mode (5 questions)
- ✅ Verify questions show interactive canvas
- ✅ Verify questions ask to graph slope-intercept equations
- ✅ Complete challenge successfully

#### Test 2: Graph: Point-Slope Challenge
- ✅ Navigate to Graph: Point-Slope tab
- ✅ Start Challenge mode
- ✅ Verify point-slope graphing questions appear

#### Test 3: Graph: Parallel Lines Challenge
- ✅ Navigate to Graph: Parallel Lines tab
- ✅ Start Challenge mode
- ✅ Verify 2-step parallel line graphing questions appear

#### Test 4: Graph: Perpendicular Lines Challenge
- ✅ Navigate to Graph: Perpendicular Lines tab
- ✅ Start Challenge mode
- ✅ Verify 2-step perpendicular line graphing questions appear

#### Test 5: Graph: Absolute Value Challenge
- ✅ Navigate to Graph: Absolute Value tab
- ✅ Start Challenge mode
- ✅ Verify 3-point absolute value graphing questions appear

#### Test 6: Regression - Existing Tabs
- ✅ Verify Slope & Description Challenge still works
- ✅ Verify Line Relationship Challenge still works
- ✅ Verify other existing tabs still work correctly
...
3. `mapTabToProblemType("graph-slopeintercept")` → `"graphSlopeIntercept"`
4. `initializeChallenge("graphSlopeIntercept", 5)`
5. Challenge shows correct graphing questions ✅
...
- **Related Modes**:
  - Practice mode: ✅ Not affected (already working)
  - Session mode: ✅ Now works correctly (same fix applies)
...
**Fix Complexity**: Simple (add missing mappings)  
